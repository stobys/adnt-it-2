...
function initCountDownTimer() {
	console.log('-- call initCountDownTimer()');

	$('#countdownClock').countdown($('#finalCountdownDate').val())
...
$('#quizStartWizard').on('finished.fu.wizard', function (evt, data) {
	console.log('finished.fu.wizard');
});
