...
class UserEventsSubscriber
{
    ...
    public function onLoginFailed($event)
    {
        ...
        // Log::notice('AUTH / login failed / '. $event -> credentials['username'] .' / '. $_SERVER['REMOTE_ADDR']);
    }
    ...
    {
        // $remoteAddr = array_key_exists('REMOTE_ADDR', $_SERVER) ? $_SERVER['REMOTE_ADDR'] : 'BATCH';
        // Log::notice('AUTH / password change / '. $event -> user -> username .' / '. optional($event -> executor) -> username .' / '. $remoteAddr);
    }
}
